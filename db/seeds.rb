...
#   cities = City.create([{ name: 'Chicago' }, { name: 'Copenhagen' }])
  ...
  Comment.create({ text:"I agree", post_id:1, user_id:1, commentable_id: 1})
  Comment.create({ text:"totally wrong", post_id:1, user_id:2, commentable_id: 1})
  Comment.create({ text:"nope", post_id:2, user_id:3, commentable_id: 2})
  Comment.create({ text:"thats just cruel...", post_id:4, user_id:4, commentable_id: 4})
